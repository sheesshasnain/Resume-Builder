     ...
     const featuresData = [
        {
            ...
            description: "Generate complete, professional resumes in moments no hassle, no guesswork.",
        },
        {
            ...
            title: "Built for Getting Hired",
            description: "Optimized for ATS systems and designed to stand out to recruiters.",
        },
        {
            ...
            description: "Refine every detail with ease to match your style and career goals.",
        }
    ];
   return (
        <>
            <div class="text-center">
                <p class="text-center font-medium text--400 px-10 py-1.5 rounded-full bg-violet-500 border border-white-1000 w-max mx-auto">Features</p>
                <h2 class="text-3xl font-semibold text-center mx-auto mt-4 text-black">🧠Intelligent Resume Creation</h2>
                <p class="mt-2 text-slate-300 max-w-xl mx-auto">
                    Craft impactful resumes powered by advanced AI that understands your strengths.
                </p>
            </div>
